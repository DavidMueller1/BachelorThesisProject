...
#
# experiment_handler = ExperimentSaveRepeatLuna(number_of_experiments=number_of_experiments, dir_name=folder_name,
#                                               file_name=file_name, params=params, start_number=9, epsilon_in_reward=False)
# experiment_handler.start_experiments()
#
#
#
...
experiment_handler = ExperimentSaveRepeatLuna(number_of_experiments=number_of_experiments, dir_name=folder_name,
                                              file_name=file_name, params=params, start_number=8, epsilon_in_reward=True)
experiment_handler.start_experiments()
...
#
# experiment_handler = ExperimentSaveRepeatLuna(number_of_experiments=number_of_experiments, dir_name=folder_name,
#                                               file_name=file_name, params=params, start_number=5, epsilon_in_reward=True)
# experiment_handler.start_experiments()